...
from fairseq import rouge, checkpoint_utils, options, progress_bar, tasks, utils
...
def main(args):
    ...
    # score = rouge.rouge([sent_tokenize(hyp) for hyp in hyp_list], [sent_tokenize(ref) for ref in ref_list])
