...
def get_preprocessing_parser(default_task='summarization'):
    parser = get_parser('Preprocessing', default_task)
    add_preprocess_args(parser)
    return parser


def get_training_parser(default_task='summarization'):
...
def get_generation_parser(interactive=False, default_task='summarization'):
...
def get_interactive_generation_parser(default_task='summarization'):
...
def get_parser(desc, default_task='summarization'):
...
def add_generation_args(parser):
    ...
    group.add_argument('--score-reference', action='store_true',
                       help='just score the reference summarization')
    ...
    parser.add_argument('--answer-output-path', metavar='DIR', default='answer',
