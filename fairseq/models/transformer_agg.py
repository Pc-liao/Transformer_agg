...
from fairseq.modules import (
    ...
    MultiheadAttention,
    # EtasdMultiheadAttention,
    TransformerDecoderLayer,
    TransformerEncoderLayer,
)

DEFAULT_MAX_SOURCE_POSITIONS = 10240
DEFAULT_MAX_TARGET_POSITIONS = 10240


@register_model('transformer_agg')
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--agg-method', type=str, metavar='STR', default='attn',
                            help='aggregation method(add, fc, attn)')
        parser.add_argument('--agg-layers', type=int, metavar='N',
                            help='num aggregation attention layers')
        parser.add_argument('--copy', default=False, action='store_true',
                            help='if set, use copt net')
        parser.add_argument('--use-focus-attn', default=False, action='store_true',
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        if self.agg_method == 'add':
            ...
            his = F.dropout(his, p=self.activation_dropout, training=self.training)
...
@register_model_architecture('transformer_agg', 'transformer_agg')
