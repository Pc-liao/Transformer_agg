...
class EtadsMultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, kdim=None, vdim=None, dropout=0., bias=True,
        ...
        if self.encoder_decoder_attention:
            ...
            # self.s_proj_weight = Parameter(torch.Tensor(embed_dim, embed_dim))
            self.proj_h = nn.Linear(embed_dim, embed_dim, bias=False)
            self.proj_s = nn.Linear(embed_dim, embed_dim, bias=False)
